var BasePage = {
    ...
    //領域專頁session再代入page
    BindPager3: function (navPagerIndex, startIndex, endIndex, TotalItemCount,
        currentPage, TotalPageCount, pageSize, pageSizeStoreSession, callback) {
        if (TotalPageCount >= 1) {
            var pageList = "<option value='5'" + (pageSize == 5 ? " selected='selected'" : "") + ">5</option>";
            pageList += "<option value='10'" + (pageSize == 10 ? " selected='selected'" : "") + ">10</option>";
            ...
            $("#ulPager" + navPagerIndex).empty();
            var content = '<li class="nz-page-item' + (currentPage == 1 ? ' disabled' : '') + '"> \
                                <a href="#course_zone1" aria-label="First" title="回到第一頁按鈕" rel="prev"> \
                                    <span class="d-none">回到第一頁按鈕</span> \
                                   <i class="fas fa-angle-double-left"></i> \
                                </a> \
                            </li> \
                            <li class="nz-page-item' + (currentPage == 1 ? ' disabled' : '') + '"> \
                                <a href="#course_zone1" aria-label="Previous" title="上一頁按鈕" rel="prev"> \
                                     <span class="d-none">上一頁按鈕</span> \
                                    <i class="fas fa-angle-left"></i> \
                                </a> \
                            </li>'; 
            ...
            if (TotalPageCount <= maxPageCount + 2) {
                for (var i = 1; i <= TotalPageCount; i++) {
                    content += ' \
                        <li class="nz-page-item' + (currentPage == i ? ' active' : '') + '"><a href="#course_zone1" title="第' + i + '頁" rel="' + (currentPage > i ? 'prev' : 'next') + '">' + i + '</a></li>';
                }
            }
            else {
                if (currentPage < maxPageCount) {
                    ...
                    content += ' \
                        <li>…</li>';
                    content += ' \
                        <li class="nz-page-item' + (currentPage == TotalPageCount ? ' active' : '') + '"><a href="#course_zone1" title="第' + TotalPageCount + '頁" rel="' + (currentPage > i ? 'prev' : 'next') + '">' + TotalPageCount + '</a></li>';
                }
                else if (currentPage >= maxPageCount && currentPage <= TotalPageCount - maxPageCount + 1) {
                    //中間
                    content += ' \
                        <li class="nz-page-item' + (currentPage == 1 ? ' active' : '') + '"><a href="#course_zone1" title="第' + 1 + '頁" rel="' + (currentPage > i ? 'prev' : 'next') + '">' + 1 + '</a></li>';
                    content += ' \
                        <li>…</li>';
                    for (var i = currentPage - 1; i <= currentPage + 1; i++) {
                        content += ' \
            ...
            content += ' \
                        <li class="nz-page-item' + (currentPage == TotalPageCount ? ' disabled' : '') + '"> \
                            <a href="#course_zone1" aria-label="Next" title="下一頁按鈕" rel="next"> \
                                <span class="d-none">下一頁按鈕</span> \
                                <i class="fas fa-angle-right"></i> \
                            </a> \
                        </li> \
                        <li class="nz-page-item' + (currentPage == TotalPageCount ? ' disabled' : '') + '"> \
                            <a href="#course_zone1" aria-label="Last" title="到最後一頁按鈕" rel="next"> \
                                <span class="d-none">到最後一頁按鈕</span> \
                                <i class="fas fa-angle-double-right"></i> \
                            </a> \
                        </li>';
